...
<picture>
  ...
  <img alt="GTNH Daily 汉化进度（最近 90 天）" src="progress/progress.svg" title="GTNH Daily 汉化进度 · 近3天 08-18 99.94% → 08-19 100.00% → 08-20 99.50% · 最新 84,430/84,852 词条">
</picture>
<!-- progress-chart:end -->
...
- 汉化文本部分采用 **[CC BY-NC-SA 4.0](LICENSE-TRANSLATIONS.md)**
- 仓库内脚本、工作流及其他程序代码采用 **[GPL-3.0-only](LICENSE)**
